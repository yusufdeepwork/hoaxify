...
public class HoaxController {
    ...
    ResponseEntity<?> getHoaxesRelative(@PageableDefault(sort = "id", direction = Sort.Direction.DESC) Pageable page,
                                        ...
                                        @RequestParam(name="count", required = false,
                                                defaultValue = "false") boolean count,
    ...
    ResponseEntity<?> getUserHoaxesRelative(@PathVariable long id, @PathVariable String username, @PageableDefault(sort = "id", direction = Sort.Direction.DESC) Pageable page,
